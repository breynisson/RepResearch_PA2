...
From the two tables, we see that tornados are the biggest cause of injuries, and the second biggest cause of fatalities. The number one cause of fatalities is heat. 
...
```{r}
per_state_fatal<-ddply(data, .variables="STATE", fun=variables[order(-data$FATALITIES),])
per_state_fatal
```
